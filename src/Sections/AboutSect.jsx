...
const AboutSect = () => {
  return (
   ...
   <div className='grid grid-cols-2'>
    ...
    <div className='bg-primarycolor px-[30px] py-[30px] rounded-[24px]  '>
        <h2 className='text-secondarycolor text-[50px] font-kurale font-[600]'>
          About Us
        </h2>
        <p className='pt-[20px] text-[17px] text-secondarycolor font-poppins text-justify overflow-hidden'>
        ...
        <Button bg='secondarycolor' txtclr='primarycolor' textsize='14' text='Read More'/>
